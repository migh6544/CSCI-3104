...
\begin{center}
	...
	\path [red] (A) edge node[above] {$4$} (B);
	\path (A) edge node[above] {$8$} (C);
	\path [red] (B) edge node[above] {$1$} (G);
	\path [red] (B) edge node[above] {$6$} (D);
	\path (G) edge node[above] {$2$} (A);
	\path (E) edge node[above] {$1$} (C);
	\path (D) edge node[above] {$3$} (G);
	\path (D) edge node[above] {$10$} (F);
	\path [red] (F) edge node[above] {$2$} (E);
	\path (G) edge node[above] {$5$} (E);
	\path [red] (G) edge node[above] {$2$} (F);
	\path [red] (G) edge node[above] {$2$} (C);
